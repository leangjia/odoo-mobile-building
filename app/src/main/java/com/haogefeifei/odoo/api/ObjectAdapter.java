...
import com.haogefeifei.odoo.api.Field.FieldType;
import com.haogefeifei.odoo.api.FilterCollection.FilterOperator;
import com.haogefeifei.odoo.api.helpers.FilterHelper;
                    ...
                    if (value instanceof String) {
                        for (String singleID : value.toString().split(","))
                            if (idToName.containsKey(singleID))
                                ...
                                throw new OpeneERPApiException("Could not find " + fld.getRelation() + " with ID " + singleID);
                    } else {
                        ...
                        for (Object singleID : (Object[]) value)
                            if (idToName.containsKey(singleID.toString()))
                                ...
                                throw new OpeneERPApiException("Could not find " + fld.getRelation() + " with ID " + singleID.toString());
                    }
