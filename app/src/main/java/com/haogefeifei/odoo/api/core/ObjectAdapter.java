package com.haogefeifei.odoo.api.core;

import com.haogefeifei.odoo.api.core.Field.FieldType;
import com.haogefeifei.odoo.api.core.FilterCollection.FilterOperator;
import com.haogefeifei.odoo.api.core.helpers.FilterHelper;
...
public class ObjectAdapter {
     ...
     * Default constructor
     *
     * @param odooSession OdooSession object that will be used to make the calls
...
//	}
     ...
     * @param functionName function to call
     * @param parameters   Additional parameters that will be passed to the object
     * @param fieldCol     An option field collection to use. A new one will be built by
