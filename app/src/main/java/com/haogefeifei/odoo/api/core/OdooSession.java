...
import com.haogefeifei.odoo.api.core.xmlrpc.OdooXmlRpcClient.RPCServices;
import com.haogefeifei.odoo.api.core.xmlrpc.OdooXmlRpcTemplate;
...
public class OdooSession {
     ...
     * @param parameters  List of parameters for the command. For easy of use, consider
