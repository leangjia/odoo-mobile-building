...
public class Row {
     ...
     * Default constructor
     *
     * @param openERPResult The HashMap object returned from readObject. containing all
     *                      data for this row
     ...
     * @param append    If the values should be added to the existing values. If not,
